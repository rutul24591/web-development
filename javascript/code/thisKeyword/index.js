...
// this is global space is window object 
...
// Without strict mode the below this is the Window object
// "use strict" at top to make this strict mode(stricter rules) in which case below this would be undefined
    console.log('this in function space of x()', this);
}
x();


// 3. this in non-strict node (this substitution)
