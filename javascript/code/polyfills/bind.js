// What if you want to use bind but it is not available in some browsers,
// we have to implement it manually(polyfill).
...
// Task is to write custom bind function which should be available for use
// just like bind method
