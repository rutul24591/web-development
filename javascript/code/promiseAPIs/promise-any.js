 ...
 * Result is the first success settled promise()
 * On all error scenario, it will give out AggregateError: All promises were rejected
 */
...
//     })
//     .catch((error) => {
//         console.error('Error encountered in promise any example:', error);
//     });
...
//     })
//     .catch((error) => {
//         console.error('Error encountered in promise any p1 fail example:', error);
//     });
...
//     })
//     .catch((error) => {
//         console.error('Error encountered in promise any p2 fail example:', error)
//     });
...
//     })
//     .catch((error) => {
//         console.error('Error encountered in promise any p3 failure example:', error);
