...
// Consider a e commerce website which lists catgories and has several categories within like Laptops,
...
// Now adding event listeners on each would make it very cumbersome and inefficient because an ecommerce page might have 
// 100s or 1000s of items and attaching event listeners to each with bubbling and capturing is feasible.
...
// 2. Less code
// 3. Dom manipulation. New children are added to categories no extra event needs to be added.
...
document.querySelector('#category')
    .addEventListener('click', (event) => {
        ...
        // Navigate now after getting id. Not a good way. Consider the list has many different element which are not to be routed.
