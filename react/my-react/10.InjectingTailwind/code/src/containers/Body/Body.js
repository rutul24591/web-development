        ...
        return (
            <div className="m-[15px]">
                ...
                <div className="flex justify-between items-center m-[15px]">
                    <div className="m-[15px] border border-solid border-gray-50">
                        <input
                    ...
                    <div className="flex justify-start items-center w-2xs">
                        <p className="p-1.5">Filter:</p>
                        <button
                            className="p-1.5 cursor-pointer border-none text-emerald-900 bg-green-100 rounded-xl text-black"
                            onClick={() => {
