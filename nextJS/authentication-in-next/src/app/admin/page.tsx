/** To view this page you not only be signed in but also have admin role.
 * To protect this route we will apply RBAC (Role Based Access Control) in our middleware.tsx
 * */
